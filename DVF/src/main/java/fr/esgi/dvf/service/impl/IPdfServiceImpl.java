...
@Service
public class IPdfServiceImpl implements
                            IPdfService {

  private static final String PDF_DIR = "static/pdf/";
  private static final Logger LOGGER = LogManager.getLogger(IPdfServiceImpl.class);
  ...
  @Override
  public DocumentWithFileName pdfDocumentProvider(String fileNames) {
